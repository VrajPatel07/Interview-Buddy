...
import { Loader2, UserCircle, Save, X } from "lucide-react"
...
export default function UpdateCandidateProfile({ candidate }: Props) {
                ...
                >
                    ...
                    <div className="flex flex-col items-center sm:flex-row sm:items-start gap-6 p-4 rounded-xl bg-zinc-950/50 border border-zinc-800/50">
                        <Avatar className="w-20 h-20 border-2 border-zinc-800 shadow-md">
                            <AvatarImage src={fileURL || form.getValues("avatar")} />
                        ...
                        <div className="flex-1 space-y-2 w-full">
                            <FieldLabel className="text-zinc-300 font-medium">Avatar</FieldLabel>
